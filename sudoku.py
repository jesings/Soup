...
with open(sys.argv[1],'r') as inputfile, open(sys.argv[2],'w') as outputfile:
    ...
    elimcliques(board,8)
    elimcliques(board,9)
    elimcliques(board,10)
    elimcliques(board,11)
    elimcliques(board,12)
    elimcliques(board,13)
    elimcliques(board,14)
    elimcliques(board,15)
    elimcliques(board,16)
    elimcliques(board,17)
    elimcliques(board,18)
    elimcliques(board,19)
    elimcliques(board,20)
    elimcliques(board,21)
    elimcliques(board,22)
    elimcliques(board,23)
    elimcliques(board,24)
    elimcliques(board,25)
    elimcliques(board,26)
    elimcliques(board,27)
    elimcliques(board,28)
    elimcliques(board,29)
    elimcliques(board,30)
    elimcliques(board,31)
    elimcliques(board,32)
    elimcliques(board,33)
    elimcliques(board,34)
    elimcliques(board,35)
    elimcliques(board,36)
    elimcliques(board,37)
    elimcliques(board,38)
    elimcliques(board,39)
    elimcliques(board,40)
    elimcliques(board,41)
    elimcliques(board,42)
    elimcliques(board,43)
    elimcliques(board,44)
    elimcliques(board,45)
    elimcliques(board,46)
    elimcliques(board,47)
    elimcliques(board,48)
    elimcliques(board,49)
    elimcliques(board,50)
    elimcliques(board,51)
    elimcliques(board,52)
    elimcliques(board,53)
    elimcliques(board,54)
    elimcliques(board,55)
    elimcliques(board,56)
    elimcliques(board,57)
    elimcliques(board,58)
    elimcliques(board,59)
    elimcliques(board,60)
    elimcliques(board,61)
    elimcliques(board,62)
    elimcliques(board,63)
    elimcliques(board,64)
    elimcliques(board,65)
    elimcliques(board,66)
    elimcliques(board,67)
    elimcliques(board,68)
    elimcliques(board,69)
    elimcliques(board,70)
    elimcliques(board,71)
    elimcliques(board,72)
    elimcliques(board,73)
    elimcliques(board,74)
    elimcliques(board,75)
    elimcliques(board,76)
    elimcliques(board,77)
    elimcliques(board,78)
